...
//import ru.yandex.qatools.htmlelements.loader.decorator.T;
...
/**
 * Contains methods for blocks of elements initialization and page objects
 * initialization.
 *
 * @author Alexander Tolmachev starlight@yandex-team.ru Date: 13.08.12
 */
public class HtmlElementLoader {
	/**
	 * Creates and initializes a block of elements if the given class is
	 * {@link HtmlElement} or its successor and initializes page object
	 * otherwise.
	 *
	 * @param clazz
	 *            A class to be instantiated and initialized.
	 * @param driver
	 *            The {@code WebDriver} instance that will be used to look up
	 *            the elements.
	...
	/**
	 * Initializes {@code instance} as a block of elements it is instance of
	 * {@link HtmlElement} or its successor and as a page object otherwise.
	 *
	 * @param instance
	...
	/**
	 * Creates an instance of the given class representing a block of elements
	 * and initializes its fields with lazy proxies.
	 * <p/>
	 * Processes annotation of the given class to set the way of locating the
	 * block itself and {@link org.openqa.selenium.support.FindBy},
	 * {@link org.openqa.selenium.support.FindBys} and
	 * {@link org.openqa.selenium.support.FindAll} annotations of its fields for
	 * setting the way of locating elements of the block.
	 * <p/>
	 ...
	 * <li>Typified element (
	 * {@link ru.yandex.qatools.htmlelements.element.TypifiedElement}
	 * successors)</li>
	 ...
	 *            A class to be instantiated and initialized.
	 * @param searchContext
	 *            {@code SearchContext} that will be used to look up the
	 *            elements.
	 * @return Initialized instance of the specified class.
	 */
	...
	/**
	 * Creates an instance of the given page object class and initializes its
	 * fields with lazy proxies.
	 * <p/>
	 * Processes {@link org.openqa.selenium.support.FindBy},
	 * {@link org.openqa.selenium.support.FindBys} and
	 * {@link org.openqa.selenium.support.FindAll} annotations of the fields for
	 * setting the way of locating them.
	 * <p/>
	 * Fields to be proxied:
	 * <p/>
	 * <ul>
	 ...
	 * <p/>
	 * Processes annotation of the class of the given block to set the way of
	 * locating the block itself and {@link org.openqa.selenium.support.FindBy},
	 * {@link org.openqa.selenium.support.FindBys} and
	 * {@link org.openqa.selenium.support.FindAll} annotations of its fields for
	 * setting the way of locating elements of the block.
	 * <p/>
	 ...
	 *
	 * @param htmlElement
	 *            Block of elements to be initialized.
	 * @param searchContext
	 *            {@code SearchContext} that will be used to look up the
	 *            elements.
	 */
	...
	/**
	 * Initializes fields of the given block of elements using specified locator
	 * factory.
	 *
	 * @param htmlElement
	 *            Block of elements to be initialized.
	 * @param locatorFactory
	 *            Locator factory that will be used to locate block elements.
	 */
...
//		populatePageObject(page, new HtmlElementLocatorFactory(searchContext, corrector));
//	}

	/**
	 * Initializes fields of the given page object using specified locator
	 * factory.
	 *
	 * @param page
	 *            Page object to be initialized.
	 * @param locatorFactory
	 *            Locator factory that will be used to locate elements.
	 */
	public static void populatePageObject(Object page, CustomElementLocatorFactory locatorFactory) {
		 PageFactory.initElements(new HtmlElementDecorator(locatorFactory),
		 page);
//		PageFactory.initElements(new HtmlElementDecorator(locatorFactory, ((HtmlElement) page).getWrappedDriver()),
//				page);
	}
}
